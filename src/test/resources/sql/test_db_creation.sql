...
-- -----------------------------------------------------
-- -----------------------------------------------------
-- Schema tax_data_test
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `tax_data_test` ;

-- -----------------------------------------------------
-- Schema tax_data_test
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `tax_data_test` DEFAULT CHARACTER SET cp1251 ;
USE `tax_data_test` ;

-- -----------------------------------------------------
-- Table `tax_data_test`.`entrepreneur_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tax_data_test`.`entrepreneur_type` ;

CREATE TABLE IF NOT EXISTS `tax_data_test`.`entrepreneur_type` (
...
-- -----------------------------------------------------
-- Table `tax_data_test`.`period`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tax_data_test`.`period` ;

CREATE TABLE IF NOT EXISTS `tax_data_test`.`period` (
                                                   `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `tax_data_test`.`status`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tax_data_test`.`status` ;

CREATE TABLE IF NOT EXISTS `tax_data_test`.`status` (
                                                   `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `tax_data_test`.`role_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tax_data_test`.`role_type` ;

CREATE TABLE IF NOT EXISTS `tax_data_test`.`role_type` (
                                                      `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `tax_data_test`.`user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tax_data_test`.`user` ;

CREATE TABLE IF NOT EXISTS `tax_data_test`.`user` (
                                                 `id` INT NOT NULL AUTO_INCREMENT,
                                                 ...
                                                 CONSTRAINT `fk_user_entrepreneur_type1`
                                                     FOREIGN KEY (`entrepreneur_type_id`)
                                                         REFERENCES `tax_data_test`.`entrepreneur_type` (`id`)
                                                         ON DELETE CASCADE
                                                         ON UPDATE CASCADE,
                                                 CONSTRAINT `fk_user_role_type`
                                                     FOREIGN KEY (`role_id`)
                                                         REFERENCES `tax_data_test`.`role_type` (`id`)
                                                         ON DELETE CASCADE
                                                         ON UPDATE CASCADE)
    ENGINE = InnoDB
    DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `tax_data_test`.`report`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tax_data_test`.`report` ;

CREATE TABLE IF NOT EXISTS `tax_data_test`.`report` (
                                                   `id` INT NOT NULL AUTO_INCREMENT,
                                                   ...
                                                   CONSTRAINT `fk_report_d_period1`
                                                       FOREIGN KEY (`period_id`)
                                                           REFERENCES `tax_data_test`.`period` (`id`)
                                                           ON DELETE CASCADE
                                                           ON UPDATE CASCADE,
                                                   CONSTRAINT `fk_report_status1`
                                                       FOREIGN KEY (`status_id`)
                                                           REFERENCES `tax_data_test`.`status` (`id`)
                                                           ON DELETE CASCADE
                                                           ON UPDATE CASCADE,
                                                   CONSTRAINT `fk_report_user1`
                                                       FOREIGN KEY (`user_id`)
                                                           REFERENCES `tax_data_test`.`user` (`id`)
                                                           ON DELETE CASCADE
                                                           ON UPDATE CASCADE)
    ENGINE = InnoDB
    DEFAULT CHARACTER SET = utf8mb4
